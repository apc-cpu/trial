...
from charts.charts import (
    ...
    chart_context_wind_distribution,
)
...
st.header("5) How windy is Seattle?")
st.write("Wind is another important part of daily weather. While temperature and precipitation show strong seasonal patterns, wind tends to vary within a narrower range.")
st.altair_chart(chart_context_wind_distribution(df), use_container_width=True)
st.caption("Takeaway: Most days fall within a moderate wind range, with very few high‑wind outliers.")
